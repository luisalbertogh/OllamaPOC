...
from smart_chat.llm_tools import multiply
...
def init_chat():
    ...
    smart_chat = SmartChatWrapper(model_name="llama3.1", base_url="http://localhost:11434", tools=[multiply])
